            ...
            <div class="col-md-8">
                <div class="writen fade">
                    ...
                    <ul>
                        ...
                        <li><b>FOR TIS, VV STUDENTS ONLY:</b> Even though you guys won't be on the final leaderboard, don't worry we will award you for your merit</li>
                    </ul>
                    <h3>Hints & Level Skip</h3>
                    <ul>
                        <li>In case the admins feel participants are facing difficulties on a particular level, hints will be released publically totally at the admin's discretion.</li>
