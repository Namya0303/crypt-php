...
<div id="end">
    <center>
        <div class="footer-text">
            <a href="https://discord.gg/3TH32ev" class="page-links" target="_blank"><i class="fab fa-discord"></i></a>
            <a href="https://www.facebook.com/ordinatrix19.0/" class="page-links" target="_blank"><i class="fab fa-facebook-square"></i></a>
            <a href="mailto:ordinatrix10@gmail.com" class="page-links" target="_blank"><i class="fas fa-envelope"></i></a>
