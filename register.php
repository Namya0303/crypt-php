...
<div class="row home fade">
    ...
    <div class="col-md-4">
        <div class="writen right">
            <h2>Register</h2>
            <form>
                <input placeholder="Email Id" name="participant-email" type="email"><br>
                <input placeholder="Password" name="password" type="password"><br>
                <input placeholder="Confirm Password" name="password" type="password"><br>
                <a class="blue" href="login.html">Already have an account? Login.</a><br><br>                        
                <input class="button" type="submit" name="sign-up" value="Register">
            </form>
        </div>
    </div>
    <div class="col-md-2"></div>
